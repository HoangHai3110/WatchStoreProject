            ...
            <table class="products">
                ...
                if(isset($_GET['Masanpham']))
                {
                    ...
                    echo "
                        ...
                        <span class='sp3'>Thương hiệu  :   ".$dong['THUONGHIEU']."<br>
                        Màu dây  :   ".$dong['MAUDAY']."<br>
                        Màu mặt  :   ".$dong['MAUMAT']."<br>
                        Chiều rộng dây  :   ".$dong['CHIEURONGDAY']."<br>
                        Độ dày mặt  :   ".$dong['DODAYMAT']."<br>
                        Cấu tạo máy  :   ".$dong['CAUTAOMAY']."<br>
                        Chống nước tối thiểu  :   ".$dong['CHONGNUOC']."<br>
                        </span>
                        </td> </tr><br> <br>";
                }
            ?>    

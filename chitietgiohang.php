		...
		<table class="sub-shopping-products">
            <?php
                $n=sizeof($_SESSION['DSMaMua']);
                    ...
                    echo "<tr> <th> STT </th> <th align='center'> Hình </th> <th> Tên sản phẩm </th> <th> Giá tiền </th> <th align='center'>Số lượng </th><th>Thành tiền </th> </tr>";
                    $TongTien=0;
                    for($i=0;$i<$n;$i++)
                    {
                    ...
                    echo "<tr> <td align='center'>".($i+1)." </td> <td align='center'> <img src='".$dong['HINH']."'></td> 
                    ...
                    echo "<tr> <td colspan='5'> Tổng tiền </td> <td>".number_format($TongTien)." đồng </td> </tr>";  
                ?>
		</table>
		</form> 
</article>
